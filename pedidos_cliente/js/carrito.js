class Carrito {
    ...
    leerDatosProducto(producto){
        const infoProducto = {
            ...
            precio: producto.querySelector('.pagar span').textContent,
    ...
    leerLocalStorageCompra(){
        ...
        productosLS.forEach(function (producto){
            ...
            row.innerHTML= `
                ...
                <td>${producto.precio}</td>
                <td>
                    <input type="number"  class="form-control cantidad" min="1"  name="CANTIDAD[]" value=${producto.cantidad}>
                </td>
